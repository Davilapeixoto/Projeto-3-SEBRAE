...
import { Pill, PillAvatar, PillAvatarGroup } from "../ui/pill"
      ...
      <div className="mt-16 flex flex-col items-center gap-6">
        <Pill>
          ...
          <p className="text-muted-foreground px-2 text-xs font-medium sm:border-l sm:text-sm">
            Join <span className="text-foreground">3 Million</span> other users
            already on board
          </p>
        </Pill>
        ...
        <p className="max-w-lg text-center leading-6 tracking-tight sm:text-xl">
          Powerful, intuitive, and ready to make your life easier, start using
          Acme App today.
        </p>
